...
public class CadastroView extends javax.swing.JFrame {
        private javax.swing.JButton jButt_Alterar;
        private javax.swing.JButton jButt_Puscar;
        private javax.swing.JButton jButt_Excluir;
        ...
        public CadastroView(Pessoa user) {
                initComponents();
                this.entyPessoa = new Pessoa();
                this.pessoaController = new PessoaController();
                initMetods();
        ...
        private void update() {
                ...
                int idUser = Integer.parseInt(
                                String.valueOf(jTab_Informacoes.getValueAt(jTab_Informacoes.getSelectedRow(), 0)));
                Pessoa user = this.pessoaController.findById(idUser);

                UpdateView view = new UpdateView(user);
        ...
        private void initComponents() {
                ...
                jButt_Alterar = new javax.swing.JButton();
                jButt_Excluir = new javax.swing.JButton();
                ...
                jButt_Puscar
                                .setIcon(new javax.swing.ImageIcon(
                                                getClass().getResource("/com/cadastro_pc/resources/pesquisar.png"))); // NOI18N
                ...
                jButt_Alterar.setText("Alterar");
                jButt_Alterar.addActionListener(new java.awt.event.ActionListener() {
                        public void actionPerformed(java.awt.event.ActionEvent evt) {
                                jButt_AlterarActionPerformed(evt);
                        }
                });

                jButt_Excluir.setText("Excluir");
                jButt_Excluir.addActionListener(new java.awt.event.ActionListener() {
                        public void actionPerformed(java.awt.event.ActionEvent evt) {
                                jButt_ExcluirActionPerformed(evt);
                        }
                });
                                                                                ...
                                                                                .addGroup(jPanel1Layout
                                                                                                ...
                                                                                                .addGroup(jPanel1Layout
                                                                                                                ...
                                                                                                                .addGroup(jPanel1Layout
                                                                                                                                ...
                                                                                                                                .addGap(234, 234,
                                                                                                                                                234)
                                                                                                                                .addComponent(jButt_Alterar,
                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                                                                100,
                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                                                                .addGap(180, 180,
                                                                                                                                                180)
                                                                                                                                .addComponent(jButt_Excluir,
                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                                                                100,
                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        private void jButt_AlterarActionPerformed(java.awt.event.ActionEvent evt) {
                if (jTab_Informacoes.getSelectedRowCount() > 0) {
                        this.update();
                } else {
                        Message.erroTrist(null, "Selecione um registro da tabela para alterar.");
                }
        }

        private void jButt_ExcluirActionPerformed(java.awt.event.ActionEvent evt) {
                if (jTab_Informacoes.getSelectedRowCount() > 0) {
                        this.delete();
                } else {
                        Message.erroTrist(null, "Selecione um registro da tabela para alterar.");
